...
import { BookOpen, Award, Link as LinkIcon, UserCheck, Check, Save, ExternalLink, Trash2, Plus, AlertCircle, Eye } from "lucide-react";
      ...
      <main className="flex-grow p-8 overflow-y-auto">
        <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 border-b border-slate-200 pb-4">
          <div>
            ...
            <p className="text-xs text-text-slate font-medium">Control de avance escolar, calificaciones de alumnos y gestión de materias.</p>
          </div>
